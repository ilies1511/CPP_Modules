...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/14 16:45:52 by iziane            #+#    #+#             */
/*   Updated: 2024/11/14 16:45:54 by iziane           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ClapTrap
{
	...
	public:
		...
		void setHitPoint(size_t const InputHitPoint);
		void setEnergyPoint(size_t const InputEnergyPoint);
		//getter
